 ...
 <li><a  href="index.php">Inicio</a></li>
  <li ><a  href="formulario_titulado.php">Ingresar Nuevo titulado</a></li>
   <li><a  href="formulario_carrera.php">Nueva Carrera</a></li>
    <li><a  class="active" href="formulario_estado.php">Nuevo estado</a></li>
  ...
  <li id="derecha"><a onclick="sesion()" > cerrar sesión</a></li>
	...
	<form action="insertar_estado.php" 
	method="POST" enctype="multipart/form-data">
		<h2>Registrar Nuevo Estado</h2>
		Estado: <br>
		<input style="text-transform:uppercase;" type="text" name="nombre_estado" required="" placeholder="Nombre de estado"> 
