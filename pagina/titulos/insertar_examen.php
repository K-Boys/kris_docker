...
$mes=$_POST["mes"];
$año=$_POST["año"];
$fk_titulo=$_POST["fk_titulo"];

require_once("clases/clases_examen_prof.php");
$examen=new Examen_prof();

$resultado=$examen->insertar2($dia, $mes, $año, $fk_titulo);
...
function alerta2(){
 Swal.fire({
   title: '¡¿EXAMEN REGISTRADO EXITOSAMENTE!',
   text: '',
   type: 'success',
 }).then((result) => {
