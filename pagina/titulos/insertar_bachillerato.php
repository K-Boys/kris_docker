<?php
$nombre_bachillerato=strtoupper($_POST["nombre_bachillerato"]);
$fk_estado=$_POST["fk_estado"];

require_once("clases/clases_bachillerato.php");
$bachillerato=new Bachillerato();

$resultado=$bachillerato->insertar($nombre_bachillerato, $fk_estado);
...
function alerta2(){
 Swal.fire({
   title: '¡BACHILLERATO REGISTRADO EXITOSAMENTE!',
   text: '',
   icon: 'success',
 }).then((result) => {
